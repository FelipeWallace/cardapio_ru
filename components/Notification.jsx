...
const Notification = ({ message, type, clearMessage }) => {
  ...
  return (
    <div className={`fixed top-4 left-4 right-4 mx-auto p-4 rounded shadow-lg transition-transform duration-300 ${notificationStyle} z-50 sm:right-4 sm:left-auto`}>
      {message}
    </div>
